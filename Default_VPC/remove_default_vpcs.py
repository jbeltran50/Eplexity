...
def getRegions():
    try:
        ...
        print("Have you configured your AWS region?  (e.g. in ~/aws/credential)  See 'aws configure' ")
    ...
    try:
        ...
        print("Have you configured your AWS credentials?  (e.g. in ~/aws/credential)  See 'aws configure' ")
